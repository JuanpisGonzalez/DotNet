...
namespace SimpleDotNetMvcCrud.Controllers
{
    public class PersonController : Controller
    {
        private readonly SimpleDotNetMvcCrudContext _context;

        public PersonController(SimpleDotNetMvcCrudContext context)
        {
            _context = context;
        }
