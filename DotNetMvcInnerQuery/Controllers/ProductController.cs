...
namespace DotNetMvcInnerQuery.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ProductController(DotNetMvcInnerQueryContext context)
        {
            _context = context;
        }
        ...
        {
            var dotNetMvcInnerQueryContext = _context.Products.Include(p => p.Provider);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,ProviderId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,ProviderId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
